...
function loadFlagsFromEnv(): Partial<FeatureFlags> {
  return {
    ...
    USE_BACKEND_STATISTICS: import.meta.env.VITE_USE_BACKEND_STATISTICS === 'true',
    USE_WEBSOCKET_UPDATES: import.meta.env.VITE_USE_WEBSOCKET_UPDATES === 'true',
    ENABLE_DATA_MIGRATION: import.meta.env.VITE_ENABLE_DATA_MIGRATION === 'true',
