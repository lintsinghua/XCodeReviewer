...
export const projectApi = {
	...
	listDeleted: (params?: { page?: number; page_size?: number }) =>
		apiClient.get<PaginatedResponse<Project>>("/projects/deleted/list", {
			params,
		}),
	 ...
	 */
	restore: (id: number) => apiClient.post<Project>(`/projects/${id}/restore`),

	/**
	 * Get project statistics
	 */
	getStats: (id: number) => apiClient.get(`/projects/${id}/stats`),
};
...
export const taskApi = {
	 ...
	 * Create a new task
	 */
	create: (data: TaskCreate) => apiClient.post<AuditTask>("/tasks", data),
	 ...
	 * Get task by ID
	 */
	get: (id: number) => apiClient.get<AuditTask>(`/tasks/${id}`),
	 ...
	 * Cancel task
	 */
	cancel: (id: number) => apiClient.put(`/tasks/${id}/cancel`),

	/**
	 * Get task results
	 */
	getResults: (id: number) => apiClient.get(`/tasks/${id}/results`),
...
export const issueApi = {
	 ...
	 * Get issue by ID
	 */
	get: (id: number) => apiClient.get<AuditIssue>(`/issues/${id}`),
...
export const reportApi = {
	 ...
	 */
	create: (data: ReportCreate) => apiClient.post<Report>("/reports", data),
...
export const statisticsApi = {
	 ...
	 */
	getOverview: () => apiClient.get<OverviewStats>("/statistics/overview"),
...
export const migrationApi = {
	 ...
	 * Export user data
	 */
	exportData: () => apiClient.get<ExportData>("/migration/export"),
...
export const instantAnalysisApi = {
	...
	getSupportedLanguages: () =>
		apiClient.get<{ languages: string[] }>(
			"/instant-analysis/supported-languages",
		),
};
...
export const systemSettingsApi = {
	 ...
	 */
	getSetting: (key: string) => apiClient.get(`/system/settings/${key}`),
	 ...
	 */
	getPromptTemplates: () => apiClient.get("/system/prompt-templates"),
