 ...
 */
import type { WebSocketMessage, TaskProgressMessage, WebSocketMessageType } from '../../types/api';
...
export function useTaskProgress(taskId: number, onProgress: (data: TaskProgressMessage) => void) {
  ...
  // Register handler
  const unsubscribe = wsClient.on('task_progress' as WebSocketMessageType, handleMessage);
