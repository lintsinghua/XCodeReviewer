						...
						<div className="flex-1 overflow-auto">
							<div className="p-4 space-y-4 text-sm">
								...
								<div>
									...
									<Badge
										className={`${getLevelColor(selectedLog.level)} text-white`}
									>
										{selectedLog.level}
									</Badge>
								</div>
								<div>
									...
									<Badge
										className={`${getCategoryColor(selectedLog.category)} text-white`}
									>
								...
								{selectedLog.url && (
									<div>
										...
										<div className="rounded bg-muted p-3 break-all text-xs">
											{selectedLog.url}
										</div>
									</div>
								)}
