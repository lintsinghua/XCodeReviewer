...
export const DataMigration: React.FC = () => {
	...
	const exportLocalData = async (): Promise<ExportData> => {
		...
		try {
			...
			const tasksStore = db
				.transaction(["audit_tasks"], "readonly")
				.objectStore("audit_tasks");
			...
			const issuesStore = db
				.transaction(["audit_issues"], "readonly")
				.objectStore("audit_issues");
		...
		<div className="max-w-4xl mx-auto p-6">
			<div className="bg-white rounded-lg shadow-lg p-6">
				...
				<p className="text-gray-600 mb-6">
					Migrate your local data to the backend API for improved reliability
					and features.
				</p>
